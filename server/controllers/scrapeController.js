   ...
   scrape: (req, res) => {
      ...
      axios.get("http://www.theonion.com").then(response => {
            ...
            $("article").each(function (i, el) {
               ...
               let content = []; // for now, this will be updated later to include all of the article
            ...
            db.FakeArticles
               ...
               .then(fakeArticles => {
                  ...
                  db.FakeArticles
                     .create(data)
                     .then(dbFArticle => {})
                     .catch(err => console.log(err)): console.log("Article already in Database");
               });
         });
